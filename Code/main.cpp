...
SPWM on the atMega328 , might be compatible with other atmel chips.
Compare outputs A and B output to PORTB pins 1 and 2 which are pins 9 and 10 respectively on the Chip.
Also useful to know the led on the Chip is pin 5 on PORTB.
*/
#include <avr/io.h>
